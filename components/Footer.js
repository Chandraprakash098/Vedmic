...
export default function Footer() {
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center items-center mb-6">
            <div className="w-20 h-20 rounded-xl overflow-hidden transform hover:scale-110 transition-all duration-300 shadow-lg">
  <Image
    src={logo}
    alt="Vedamic Logo"
  ...
  />
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">
             software solutions for the modern world. Building tomorrow's technology today.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              We are passionate about creating cutting-edge solutions that drive innovation and transform businesses worldwide.
            </p>
            <div className="flex space-x-4">
              <div className="w-12 h-12 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-lg flex items-center justify-center border border-orange-500/30 hover:border-orange-400 transition-all duration-300 group cursor-pointer">
                <svg className="w-6 h-6 text-orange-400 group-hover:text-orange-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <a href="mailto:info@vedamic.com" className="text-gray-300 hover:text-orange-400 transition-all duration-300">
                  info@vedamic.com
                </a>
              </div>
        ...
        <div className="mt-16 py-12 border-t border-gray-700/50">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-2xl font-bold text-orange-400 mb-4">Stay Updated</h3>
            <p className="text-gray-300 mb-8">Subscribe to our newsletter for the latest updates and insights.</p>
