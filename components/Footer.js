        ...
        <div className="text-center mb-12">
          <div className="flex justify-center items-center mb-8">
            <div className="relative group">
              {/* Outer glow ring */}
              <div className="absolute inset-0 w-40 h-36 bg-gradient-to-r from-orange-500/20 via-red-500/20 to-yellow-500/20 rounded-2xl blur-lg group-hover:blur-xl transition-all duration-500 animate-pulse"></div>
              
              {/* Middle border ring */}
              <div className="absolute inset-2 w-36 h-32 bg-gradient-to-r from-orange-500/30 to-red-500/30 rounded-xl blur-sm group-hover:from-orange-400/40 group-hover:to-red-400/40 transition-all duration-500"></div>
              
              {/* Main logo container */}
              <div className="relative w-32 h-28 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl overflow-hidden border-2 border-gradient-to-r from-orange-500/50 to-red-500/50 shadow-2xl group-hover:shadow-orange-500/25 transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-1">
                
                {/* Inner glow effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-transparent to-red-500/10"></div>
                
                {/* Animated border */}
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-500 via-red-500 to-yellow-500 opacity-0 group-hover:opacity-100 transition-all duration-500 animate-gradient-x"></div>
                <div className="absolute inset-0.5 rounded-xl bg-gradient-to-br from-gray-800 to-gray-900"></div>
                ...
                <div className="relative z-10 w-full h-full flex items-center justify-center p-2">
                  <Image
                    src={logo}
                    alt="Vedamic Logo"
                    className="object-contain w-full h-full filter drop-shadow-lg group-hover:drop-shadow-2xl transition-all duration-500"
                    priority
                  />
                </div>
                ...
                <div className="absolute top-4 right-3 w-1 h-1 bg-red-400 rounded-full animate-ping animation-delay-300"></div>
                <div className="absolute bottom-3 left-4 w-1 h-1 bg-yellow-400 rounded-full animate-ping animation-delay-600"></div>
              ...
              <div className="absolute -top-2 -right-2 w-4 h-4 bg-gradient-to-r from-orange-500 to-red-500 rounded-full opacity-60 animate-bounce animation-delay-200"></div>
              <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-gradient-to-r from-red-500 to-yellow-500 rounded-full opacity-60 animate-bounce animation-delay-500"></div>
              <div className="absolute top-1/2 -right-4 w-2 h-2 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full opacity-40 animate-pulse animation-delay-700"></div>
            </div>
          </div>
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-4 relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-red-400 to-yellow-400 bg-clip-text text-transparent blur-sm opacity-50 animate-pulse"></div>
          </h2>
          
          {/* Enhanced description */}
          <p className="text-gray-300 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
            <span className="font-semibold text-orange-300">software</span>  solutions for the modern world. 
            <span className="text-gradient bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent">
